...
const NavItem = ({ label, icon }) => (
  <div className="flex items-center gap-3 px-4 py-3 rounded-lg cursor-pointer transition-all hover:bg-white/10 group">
      ...
      <div>
        ...
        <nav className="space-y-1">
          {navItems.map((item, idx) => (
            <NavItem key={idx} label={item.label} icon={item.icon} />
          ))}
        </nav>
      </div>
